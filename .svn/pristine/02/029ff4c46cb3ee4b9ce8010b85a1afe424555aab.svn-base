...
namespace Global
{
    public abstract class Global
    {
        ...
        public static NS_Student_Search.StrongTypesNS.DS_STUDENT_SEARCHDataSet ds_stuinfo;
        ...
        public static string hallcode = "AWEBB"; /* Allan Webb to start */
        public static int rescode = 812; /* Cantebury to start */
